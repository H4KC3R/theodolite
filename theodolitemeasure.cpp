...
TheodoliteMeasure::TheodoliteMeasure(const double& hz_angle, const double& v_angle, const qint32 circle)
{
    measure_tuple=std::make_tuple(hz_angle, v_angle,circle+1);
}

void TheodoliteMeasure::setMeasureData(const double& hz_angle, const double& v_angle, const qint32 circle)
{
    measure_tuple=std::make_tuple(hz_angle, v_angle,circle+1);
}
