...
//
//              File Generator Date: 13 May 2008
//
// --------------------------------------------------------------------------------------------------------------------
//
...
extern "C" MY_EXPORT COMMON1200_FW_API GCOMS2K_API GRC_TYPE COM_NullProc(void);
extern "C" MY_EXPORT COMMON1200_FW_API GCOMS2K_API GRC_TYPE COM_GetSWVersion (short &nRel, short &nVer, short &nSubVer);
extern "C" MY_EXPORT COMMON1200_FW_API GCOMS2K_API GRC_TYPE COM_SwitchOnTPS(COM_TPS_STARTUP_MODE eOnMode);
extern "C" MY_EXPORT COMMON1200_FW_API GCOMS2K_API GRC_TYPE COM_SwitchOffTPS(COM_TPS_STOP_MODE eOffMode);
extern "C" MY_EXPORT COMMON1200_FW_API GCOMS2K_API GRC_TYPE COM_GetBinaryAvailable(BOOLE &bAvailable);
extern "C" MY_EXPORT COMMON1200_FW_API GCOMS2K_API GRC_TYPE COM_SetBinaryAvailable(BOOLE bAvailable);

 
extern "C" MY_EXPORT __declspec(dllexport) GCOMS2K_API GRC_TYPE COM_Init(void);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_End(void);
extern "C" MY_EXPORT __declspec(dllexport) GCOMS2K_API GRC_TYPE COM_OpenConnection(COM_PORT ePort,
                                      COM_BAUD_RATE &BaudRate, 
                                      short nRetries) ;
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_CloseConnection(void);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetBaudRate(COM_BAUD_RATE &eBaudRate);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_SetBaudRate(COM_BAUD_RATE eBaudRate);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetDoublePrecision(short &nDigits);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_SetDoublePrecision(short nDigits);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetComFormat(COM_FORMAT &eFormat);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_SetComFormat(COM_FORMAT eFormat);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetTimeOut(short &nSeconds);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_SetTimeOut(short nSeconds);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetTPSState(COM_TPS_STATUS &eStatus);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_UseWindow(HWND hWnd);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_SetConnDlgFlag(BOOLE bEnable);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_ViewError(GRC_TYPE RetCode,
                                 char *szCaption);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetErrorText(GRC_TYPE RetCode,
                                    char *szErrText);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE COM_GetWinSWVersion(short &nRel,
                                       short &nVer, 
                                       short &nSubVer);
...
typedef enum
{
    ...
    FTR_DEVICE_PCPARD = 1,
    FTR_DEVICE_SYSTEMMEMORY = 2,
    FTR_DEVICE_APPLICATIONMEMORY = 3
} FTR_DEVICETYPE;

typedef enum
{
    FTR_FILE_CONFIGSET              = 100,
    FTR_FILE_ANTENNAINFORMATION     = 101,
	FTR_FILE_GEOID                  = 102,
	FTR_FILE_POINTRELATEDDB         = 103,
	FTR_FILE_OBSRELATEDDB           = 104,
	FTR_FILE_OBSRELATEDDBEXT        = 54,
	FTR_FILE_ADDJOBS                = 105,
	FTR_FILE_COORDSYSTEM            = 106,
	FTR_FILE_CODELIST               = 107,
	FTR_FILE_GSI                    = 109,
	FTR_FILE_USERASCII              = 110,
	FTR_FILE_RINGBUFFER             = 111,
	FTR_FILE_RINGBUFFEREXT          = 61,
	FTR_FILE_CSCS                   = 113,
	FTR_FILE_MODEMGSMSTATIONLIST    = 115,
	FTR_FILE_CFCLOGMASK             = 116,
	FTR_FILE_FIRMWARE               = 118,
	FTR_FILE_APPLICATION            = 119,
	FTR_FILE_KEY                    = 120,
	FTR_FILE_LANGUAGE               = 121,
	FTR_FILE_TERMINAL_FW            = 122,
	FTR_FILE_FORMATFILE             = 123,
	FTR_FILE_RADAR2_CONF		    = 124,
	FTR_FILE_PZ90TRAFO              = 125,
	FTR_FILE_RINEXLOG               = 126,
	FTR_FILE_RINEXLOGEXT            = 127,
	FTR_FILE_RINEXLOGRB             = 128,
	FTR_FILE_RINEXLOGRBEXT          = 129,
	FTR_FILE_IPHOSTLIST             = 130,
	FTR_FILE_RINEXLOGZIP            = 131,
	FTR_FILE_FTPCLIENT              = 132,
	FTR_FILE_POINTIDTEMPLATE        = 150,
	FTR_FILE_SYSTEMCONFIG           = 151,
	FTR_FILE_CONFIGSETTEMP          = 152,
	FTR_FILE_SYSTEMCONFIGTEMP       = 153,
	FTR_FILE_CONFIGSETDEF           = 154,
	FTR_FILE_COORDSYSTEMTEMP        = 155,
	FTR_FILE_ALMANAC                = 156,
	FTR_FILE_APPLOGFILE             = 157,
	FTR_FILE_OWICONFIG              = 158,
	FTR_FILE_RADAR2CONFIG           = 159,
	FTR_FILE_IMAGES                 = 170,
	FTR_FILE_UNKNOWN                = 200
} FTR_FILETYPE;

typedef enum 
{
	FTR_JOBREQ_ALLJOBRELATEDFILES = 0,
	FTR_JOBREQ_ONLYPOINTRELATEDDB = 1,
	FTR_JOBREQ_ONLYOBSRELATEDDB = 2
} FTR_JOBREQTYPE;
...
COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_SetupDownload(FTR_DEVICETYPE eDeviceType, FTR_FILETYPE eFileType, char *szFileNameSrc, unsigned short unBlockSize, unsigned short &runNumOfBlocks);
COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_Download(unsigned short unBlockNumber, FTR_BLOCK &rBlock);
COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_AbortDownload(void);

COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_SetupList(FTR_DEVICETYPE eDeviceType, FTR_FILETYPE eFileType, char *szSearchPath);
COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_List(BOOLE bNext, BOOLE &rbLast, FTR_DIRINFO &rDirInfo);
COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_AbortList(void);

COMMON1200_FW_API GCOMS2K_API GRC_TYPE FTR_Delete(FTR_DEVICETYPE eDeviceType, FTR_FILETYPE eFileType, FTR_MODDATE DelDate, char *szFileName, unsigned short &runNumFilesDeleted);


const short IMG_MAX_FILE_PREFIX_LEN = 20;	//Maximal length of file name prefix
...
GCOMS2K_API GRC_TYPE IMG_TakeTccImage(IMG_MEM_TYPE eMemoryType, unsigned short& runImageNumber);
GCOMS2K_API GRC_TYPE IMG_GetTccConfig(IMG_MEM_TYPE eMemoryType, IMG_TCC_CONFIG &rParameters);
GCOMS2K_API GRC_TYPE IMG_SetTccConfig(IMG_MEM_TYPE eMemoryType, IMG_TCC_CONFIG Parameters);
GCOMS2K_API GRC_TYPE IMG_SetTccExposureTime(unsigned short unExposureTime);
...
enum TPS_DEVICE_CLASS
{
    ...
    TPS_CLASS_1103,         // TPS1100 family member,  3"
    TPS_CLASS_1105,         // TPS1100 family member,  5"
    TPS_CLASS_1101,         // TPS1100 family member,  1"
    ...
    // TPS3000 Family          ---------------------- accuracy
    TPS_CLASS_3000 = 300,   // TPS3000 family member,  0.5"
    TPS_CLASS_3001,         // TPS3000 family member,  1"

    // 1200 LITE Family          ---------------------- accuracy
    TPS_CLASS_1202_LITE = 400,  // 1200 LITE family member,  2"
    TPS_CLASS_1203_LITE,        // 1200 LITE family member,  3"
    TPS_CLASS_1205_LITE,        // 1200 LITE family member,  5"
    TPS_CLASS_1201_LITE,        // 1200 LITE family member,  1"

    // Mid Range Family           ---------------------- accuracy
    TPS_CLASS_TS01 = 500,       // Mid Range family member,  1"
    TPS_CLASS_TS02,             // Mid Range family member,  2"
    TPS_CLASS_TS03,             // Mid Range family member,  3"
    TPS_CLASS_TS05,             // Mid Range family member,  5"
    TPS_CLASS_TS07,             // Mid Range family member,  7"
    TPS_CLASS_TS10              // Mid Range family member, 10"
};
...
enum TPS_REFLESS_CLASS
{
    ...
    TPS_REFLESS_R400,                 // Dago XR with red laser
    TPS_REFLESS_R1000                 // Dago XXR with red laser
};
...
{ // Possible measuring programs, not each program will be
  // supported from the different sensor HW's
    ...
    EDM_PRECISE_IR          // S.dist   (precise    DIST , IR, l) TPS3000 only
};
...
const long  AUT_CALCDIRECTION =  0;     // Suchrichtung in die aktuelle Drehrichtung (Lock)
...
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetAngSwitch( TMC_ANG_SWITCH SwCorr );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetAngSwitch( TMC_ANG_SWITCH &SwCorr );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetInclineSwitch( ON_OFF_TYPE eSwCorr );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetInclineSwitch( ON_OFF_TYPE  &eSwCorr );



extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetSignal   ( TMC_EDM_SIGNAL    &Signal );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_QuickDist      ( TMC_HZ_V_ANG    &OnlyAngle,
                                    double          &dSlopeDistance );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetSimpleMea   ( SYSTIME         WaitTime,
                                    TMC_HZ_V_ANG    &OnlyAngle,
                                    double          &dSlopeDistance,
                                    TMC_INCLINE_PRG eMode = TMC_AUTO_INC );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetSimpleCoord ( SYSTIME         WaitTime,
                                    double          &dCoordE,
                                    double          &dCoordN,
                                    double          &dCoordH,
                                    TMC_INCLINE_PRG eMode = TMC_AUTO_INC );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetHandDist    ( double          dSlopeDistance,
                                    double          dHgtOffset,
                                    TMC_INCLINE_PRG eMode = TMC_AUTO_INC );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetAngle( TMC_ANGLE       &Angle,
                             TMC_INCLINE_PRG eMode = TMC_AUTO_INC );

 GCOMS2K_API GRC_TYPE TMC_GetAngle( TMC_HZ_V_ANG    &OnlyAngle,
                             TMC_INCLINE_PRG eMode = TMC_AUTO_INC );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_DoMeasure( TMC_MEASURE_PRG  eCommand );

 GCOMS2K_API GRC_TYPE TMC_DoMeasure( TMC_MEASURE_PRG  eCommand,
                              TMC_INCLINE_PRG  eMode );


extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetCoordinate( SYSTIME         WaitTime,
                                  TMC_COORDINATE  &Coordinate,
                                  TMC_INCLINE_PRG eMode = TMC_AUTO_INC );


extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetStation( TMC_STATION Station );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetStation( TMC_STATION &Station );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetPrismCorr( double &dPrismCorr );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetHeight( TMC_HEIGHT &Height );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetHeight( TMC_HEIGHT Height );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetOrientation   ( double dHzOrientation = 0.0 );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetPrismCorr( double dPrismCorr );


extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetFace           ( TMC_FACE &eFace );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetEdmMode( EDM_MODE eMode );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetEdmMode( EDM_MODE &eMode );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_ActivateOffsetDist();
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_DeactivateOffsetDist ();    // used in TMC-Task



extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetAtmCorr( TMC_ATMOS_TEMPERATURE AtmTemperature );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetAtmCorr( TMC_ATMOS_TEMPERATURE &AtmTemperature );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetRefractiveCorr( TMC_REFRACTION    Refractive );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetRefractiveCorr( TMC_REFRACTION    &Refractive );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetRefractiveMethod( unsigned short unMethod );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetRefractiveMethod( unsigned short &unMethod );

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetSlopeDistCorr ( double &dPpmCorr, double &dPrismCorr );


extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_IfDataAzeCorrError ( BOOLE &bAzeCorrectionError );
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_IfDataIncCorrError ( BOOLE &bIncCorrectionError );


extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetAtmPpm(double dPpmA);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetAtmPpm(double &dPpmA);

extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_SetGeoPpm(unsigned short unGeomUseAutomatic,
                                   double dScaleFactorCentralMeridian,
                                   double dOffsetCentralMeridian,
                                   double dHeightReductionPPM,
                                   double dIndividualPPM);
extern "C" MY_EXPORT GCOMS2K_API GRC_TYPE TMC_GetGeoPpm(unsigned short& unGeomUseAutomatic,
                                   double& dScaleFactorCentralMeridian,
                                   double& dOffsetCentralMeridian,
                                   double& dHeightReductionPPM,
                                   double& dIndividualPPM);
